...
Our team's six core values are
...
We take inspiration from other companies, and we always go for the [boring solutions](#boring-solutions). We've inhehited these values from [GitLab](https://about.gitlab.com/company/history/#value-origin-stories), but
just like the rest of our work, we continually adjust our values and strive to make them better.
The Inquirer's Data Engineering Team ("the DE team") values are a living document.
...
Anyone can chime in on any subject, regardless of their team.
...
* Showing thanks in as large a setting as possible at a company the size of ours is the exception instead of the norm, it takes some getting used to.
* Being thanked in a large forum for what you view as a relatively small or minuscule contribution can feel awkward.
* Thanking a person in should be done sincerely and summarize why you are thankful so the person on the receiving end can easily understand why they are being thanked. Even while [assuming positive intent](#assume-positive-intent), not all folks are comfortable with public praise. Help this person understand how they went above and beyond and why you felt it was important for the team member to be recognized.
...
On the data engineering team, we want to drive stakeholder results through focusing on platform enhancements that drive the most value for direct users.

**stakeholder results are more important** than:
...
Everyone can contribute at the Inquirer.
...
1. Be deserving of the trust of our team members, users and stakeholders.
1. Be committed to the success of the whole organization.
1. Act in the best interest of the company, our team members, our stakeholders, users, and investors.
